...
public class ParfumeDescriptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parfume_description);
        ...
        if (intent.hasExtra("title") && intent.hasExtra("info") && intent.hasExtra("imageId")) {
            ...
            Intent backToCategory = new Intent(this, ParfumeActivity.class);
